% Pandoc LaTeX template for Vietnamese academic reports
\documentclass[a4paper, 12pt]{article}

% Language and font support
$if(langvi)$
% Vietnamese support with XeLaTeX
\usepackage{fontspec}
\usepackage{polyglossia}
\setmainlanguage{vietnamese}

% Use fonts that support Vietnamese characters properly
...
% Fallback to DejaVu fonts if Noto is not available
\newfontfamily\vietnamesefont{DejaVu Serif}[
...
% Additional packages for tables and lists
\usepackage{enumitem}
\usepackage{booktabs}
...
% Hyperref package for links and bookmarks
\usepackage{hyperref}
% Hyperlink setup
\hypersetup{
    colorlinks=true,
